...
export class Footer extends BasePage {
  ...
  private informationUrlsList: Array<string> =
    ['Specials', 'New products', 'Best sellers', 'Our stores', 'Contact us', 'Порядок и условия использования', 'О компании', 'Specials', 'Sitemap'];
  
  private myAccountUrsList: Array<string> =
  ...
  public chechNewsletterSection(): this {
